...
def generar_pdf(request, ubigeo):
    ...
    for aeu_v in caso:
        ...
        viviendas_totales = Vw_Seg_Esp_R_Secdist_Secc.objects.filter(ubigeo=ubigeo).order_by('idscr', 'idaer', 'codccpp')
        ...
        data = [
            ...
            [Paragraph('<strong>PROVINCIA</strong>', h1), Paragraph(distrito.ccpp, h_center),Paragraph(distrito.cod_prov.provincia, h1), '', Paragraph('<strong>AER Nº</strong>', h1),Paragraph('Del '+aer_ini+' Al '+aer_fin, h1)],
        ...
        viviendas = Vw_Seg_Esp_R_Secdist_Secc.objects.filter(ubigeo=ubigeo).order_by('idscr', 'idaer', 'codccpp')
...
def generar_lote(request):
    ...
    # lista_distrito.append('020901')
    # lista_distrito.append('020902')
    # lista_distrito.append('020903')
    # lista_distrito.append('020904')
    # lista_distrito.append('020906')
    # lista_distrito.append('021301')
    # lista_distrito.append('021502')
    # lista_distrito.append('021504')
    # lista_distrito.append('021505')
    # lista_distrito.append('021506')
    lista_distrito.append('021301')
